function group_f2_nxV_2blocks_IC(varargin)
%addpath('C:\Users\SN\Desktop\spm12')

indir = '/Users/caro/Documents/MATLAB/fMRI/3.individual GLM/2-step_IC';
outdir = '/Users/caro/Documents/MATLAB/fMRI/4.group GLM/Smokers_IC';

input_dir = [outdir filesep 'input_f2_IC'];
output_dir = [outdir filesep 'output_f2_IC'];
mkdir(input_dir);
mkdir(output_dir);
